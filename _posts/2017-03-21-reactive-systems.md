...
Въпреки че асинхронно се случват най-различни неща в тялото ни, на едно по-високо ниво ние обичаме да мислим синхронно, тъй като това е много по-лесно. Това важи най-вече за действия, които се изпълняват за кратко време, и които имат малък шанс да се провалят. Когато обаче чакаме... Пример звънец, разглеждане на брошура, търсене на персонала. Какво значи за кратко време?
...
| Достъп до L2 кеш                         | 7               |
| Заключване/отключване на мютекс           | 25              |
...
(TODO: синхронизацията работи само за част от данните и изисква overhead и спиране на света)

За разбиране – нужно спиране на генеиране на нова информация и синхронизацията да съществуващата.
...
https://www.youtube.com/watch?v=lKXe3HUG2l4&feature=youtu.be&t=1429
